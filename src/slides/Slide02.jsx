  ...
  return (
    ...
    >
      <div className="w-full h-full flex items-center justify-center gap-12">
        {/* Left Side: Big Data Point (Donut Chart) */}
        <div className="flex-1 flex flex-col items-center justify-center h-full bg-card rounded-[24px] p-12 relative overflow-hidden">
          
          <div className="relative w-64 h-64 flex flex-col items-center justify-center rounded-full mb-8 z-10 shadow-lg"
               style={{
                 background: 'conic-gradient(#ff4b4b 0% 75.1%, #f3f4f6 75.1% 100%)'
               }}>
            {/* Inner circle to make it a donut */}
            <div className="absolute inset-[24px] bg-white rounded-full flex flex-col items-center justify-center shadow-inner">
              <span className="text-accent-red text-5xl font-black leading-none tracking-tighter">75.1%</span>
            </div>
          </div>
          
          <span className="text-primary text-xl font-extrabold z-10 text-center">전세 사기 피해자 중<br/>2030 청년 비율</span>
          
          <div className="mt-8 bg-white px-8 py-4 rounded-full shadow-sm border border-soft-border z-10">
            <span className="text-secondary text-base font-bold">생존을 위협받는 핵심 타겟</span>
          </div>
        </div>
